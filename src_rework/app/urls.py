...
urlpatterns = [
    ...
    path('locations/<str:region>/', views.list_locations, name='list_locations'),
    path('locations/manage', views.manage_locations, name='manage_locations'),

    path('locations/add', views.add_location, name='add_location'),
    path('locations/maintainers/add', views.add_maintainer, name='add_maintainer'),

    path('location/maintainers/delete', views.delete_maintainer, name='delete_maintainer'),
