...
admin.site.register(locations.ItemStackToStockRecord)
admin.site.register(locations.EnchantmentToItemStack)
admin.site.register(locations.PotionToItemStack)
